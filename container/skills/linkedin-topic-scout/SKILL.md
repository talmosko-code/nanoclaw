...
## Step 2 — Read brand docs (blocking)
...
## Step 3 — Read reference docs (style only — do NOT generate topics from these)
...
## Step 4 — Read newsletter cache (primary seed signals)
...
## Step 5 — Read Geektime cache (primary seed signals)
...
## Step 6 — Read podcast cache (primary seed signals)
...
## Step 7 — Read YouTube cache (primary seed signals)
...
## Step 8 — Read Notion for de-dup (Critical!)
...
## Step 10 — Generate up to 20 topics
...
## Step 11 — Write to Notion Topics Backlog
