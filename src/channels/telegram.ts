...
export class TelegramChannel implements Channel {
  ...
  async connect(): Promise<void> {
    ...
    // Command to show registered groups and connection status
    ...
    // Command to list available commands and capabilities
    ...
    const TELEGRAM_BOT_COMMANDS = new Set(['chatid', 'ping', 'status', 'help']);
    ...
    this.bot.on('message:voice', async (ctx) => {
      ...
      try {
        ...
        logger.warn({ err, chatJid }, 'Failed to process voice message');
